...
/*
람다식
-자바에서 함수적 프로그래밍 지원하는 기법 중에 하나이다.
...
함수형 프로그래밍을 사용하기 위한 방법으로 제공하는 것 = 함수형 인터페이스
----------------------------------------------------------------------
...
3단계 자바의 함수적 프로그래밍(람다식) 함수 사용
추상 함수는 구현부가 없고, 구현부를 람다식으로 사용
...
interface MyFunction {
    void method(); // 추상함수라 구현부가 없음
}

public class Ex03_Lambda {
    public static void main(String[] args) {
        //사용 방법 1 - (전통)클래스 이름이 없는 익명 클래스를 사용
        MyFunction myFunction = new MyFunction() {
            @Override
            public void method() { //구현체
                // 구현부
        ...
        // 사용 방법 2 - (현대적) @FunctionalInterface를 사용
