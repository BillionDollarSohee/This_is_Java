...
모두 지원하는 객체를 가리킨다. [위키백과] (JS는 일급객체이다)
...
/*
선언형의 장점은 누가 코드를 짜든 동일한 함수의 사용으로서 코드가 똑같기 때문에
함수형 프로그래밍 문법만 안다면 가독성이 올라갈 것이다.
 */
