...
2. 크롤링 (특정 페이지 원하는 정보 추출) -> 이미지 다운받아짐

샘플) http://qi-b.qoo10cdn.com/goods_image/5/2/6/3/356775263o.jpg 오류나면 s빼
*/
public class Ex01_URLConnection {
    public static void main(String[] args) throws Exception {
        ...
        URL url = new URL(urlstr); // 연결담당 (인터상에 주소)
        BufferedInputStream bis = new BufferedInputStream(url.openStream());

        URLConnection uc = url.openConnection(); // 정보파악담당
