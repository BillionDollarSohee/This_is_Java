...
<!--
	...
	1. Cookie (메모리 쿠키 or 파일 쿠키 (local 디스크에 txt 암호화 시켜서 저장 : 소멸타임)
	...
	3. server 영속적 : 파일.txt  (탭이나 엔터와 같은 규칙을 관리하므로 조작이 힘들다.)
...
<body>
		<%
			...
			response.addCookie(mycookie); //한줄 Client 에게 write
		%>
		<a href="Ex15_cookieRead.jsp">Cookie Read</a>
</body>
</html>